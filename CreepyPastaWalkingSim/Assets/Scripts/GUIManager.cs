...
public class GUIManager : MonoBehaviour, ILoggable
{
    ...
    [Tooltip("A reference to the stamina bar foreground image in the UI for the scene.")]
    ...
    /// <summary>
    /// updates the fill amount for the sprint bar foreground image
    /// </summary>
    /// <param name="sprintCharge"></param>
    public void UpdateStaminaFill(float sprintCharge)
    {
        staminaBar.fillAmount = sprintCharge / 1;
    }
}